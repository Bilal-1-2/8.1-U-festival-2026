...
(function () {
  ...
  const MARKERS = [
    ...
    { id: "bar", label: "Bar", alt: "Bar", x: 72, y: 31, color: "#8d99ae" },
    { id: "bar", label: "Bar", alt: "Bar", x: 81, y: 30, color: "#8d99ae" },
    { id: "bar", label: "Bar", alt: "Bar", x: 51, y: 43, color: "#8d99ae" },
    { id: "bar", label: "Bar", alt: "Bar", x: 12, y: 75, color: "#8d99ae" },
    {
      id: "toiletten",
      label: "Toiletten",
      alt: "Toiletten",
